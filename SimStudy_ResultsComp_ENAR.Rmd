...
for(ext_index in 2:length(file_ext)){ # skip first one, listing main directory
  ...
  if(length(file_list) > 0){
    ...
    temp_summary_table[1:length(file_list), "Model"] = stringr::str_remove(string = parsed_dirname[4], pattern = "_")
    temp_summary_table[1:length(file_list), "Scenario"] = stringr::str_remove(string = parsed_dirname[5], pattern = "_")
    temp_summary_table[1:length(file_list), "n_obs"] = stringr::str_remove(string = parsed_dirname[6], pattern = "_n")
    temp_summary_table[1:length(file_list), "SM"] = stringr::str_remove(string = parsed_dirname[7], pattern = "_")
...
# comparison
# DEE close no SM
dee_with_sm = readRDS("/projects/jklus/JKSTproj/BlueHive_Sim_Results/SummaryWorkshop/MODSUM_conjDEE_3close_n30_withSM_sim_results_2024_05_16/sum_1.rds")


# DEE close with SM
dee_no_sm = readRDS("/projects/jklus/JKSTproj/BlueHive_Sim_Results/Summary_ENAR/MODSUM_conjDEE_3close_n30_noSM_sim_results_ENAR/sum_1.rds")

mod1 = readRDS("/projects/jklus/JKSTproj/BlueHive_Sim_Results/Summary_ENAR/MODSUM_conjDEE_3wellsep_n30_noSM_sim_results_ENAR/sum_1.rds")
```
