...
for(x in 1:nreps){
        ...
        a = 1, b = 50,
        k_init = 1, diag_weights = FALSE,
        verbose = TRUE, split_merge = TRUE, sm_iter = 10
        )
}

saveRDS(object = sim_results_DEV_with_sm, file = "../MCMC_Runs/conjDEVsamp_minisimstudy_withSM_8_Jan_2024.rds")
...
saveRDS(object = sim_results_UVV_with_sm, file = "../MCMC_Runs/conjUVVsamp_minisimstudy_withSM_4_Jan_2024.rds")
```
...
saveRDS(object = sim_results_UVV_with_sm, file = "../MCMC_Runs/conjUVVsamp_minisimstudy_close_withSM_4_Jan_2024.rds")
