...
sim_diagnostic_sum <- function(data_path, sim_dir, num_traceplots){
  ...
  diagnostic_sum[i,"MAP_K"] = as.numeric(names(output$k_freqtab)[which.max(as.numeric(output$k_freqtab))])
    ...
    if(i <= num_traceplots){
        ...
        p1 = ggplot2::ggplot(mapping = aes(x = d1$transformedDraws[1][[1]]$t,
                                           y = log(d1$transformedDraws[1][[1]]$val+1))) +
              ggplot2::geom_line() +
        ...
        p2 = ggplot2::ggplot(mapping = aes(x = d2$transformedDraws[1][[1]]$t,
                                           y = log(d2$transformedDraws[1][[1]]$val+1))) +
              ggplot2::geom_line() +
              ggplot2::theme_classic() +
              ggplot2::ylab("Hamming dist") +
              ggplot2::xlab("iter") +
        ...
        p3 = ggplot2::ggplot(mapping = aes(x = d3$transformedDraws[1][[1]]$t,
                                           y = log(d3$transformedDraws[1][[1]]$val+1))) +
              ggplot2::geom_line() +
              ggplot2::theme_classic() +
              ggplot2::ylab("Hamming dist") +
              ggplot2::xlab("iter") +
        ...
        p4 = ggplot2::ggplot(mapping = aes(x=1:length(hamming_diff), y = log(hamming_diff+1))) +
          ggplot2::geom_line() +
          ggplot2::theme_classic() +
          ggplot2::ylab("Hamming dist") +
          ggplot2::xlab("iter") +
...
data_path = "/projects/jklus/JKSTproj/BlueHive_Sim_Results/SummaryUpdated"
sim_dir = "MODSUM_conjDEE_3wellsep_n30_noSM_sim_results_2024_10_24"  
...
```{r}
sim_dir = "MODSUM_conjDEE_3wellsep_n100_noSM_sim_results_2024_10_24"  
sum1 = sim_diagnostic_sum(data_path = data_path, 
                          sim_dir = sim_dir, 
                          num_traceplots = 5)
...
```{r}
sim_dir = "MODSUM_conjDEE_3wellsep_n30_withSM_sim_results_2024_10_23"  
sum1 = sim_diagnostic_sum(data_path = data_path, 
                          sim_dir = sim_dir, 
                          num_traceplots = 5)
...
```{r}
sim_dir = "MODSUM_conjDEE_3wellsep_n100_withSM_sim_results_2024_10_23"  
sum1 = sim_diagnostic_sum(data_path = data_path, 
                          sim_dir = sim_dir, 
                          num_traceplots = 5)
