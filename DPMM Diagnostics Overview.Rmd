...
These simulations used prior specifications that involved a large prior SS, i.e.
$\sigma^2 \sim IG(1,100)$. While this prior is quite large given the true variance
in the data-generating process, $\sigma^2 = 10$, it appears in the well-separated
case to result in improved clustering performance under the DPMM. 
...
# running on server
data_path = "/projects/jklus/JKSTproj/BlueHive_Sim_Results/SummaryLargePriorSS"
...
```{r}
data_path = "/projects/jklus/JKSTproj/BlueHive_Sim_Results/SummaryLargePriorSS"
sim_dir = "MODSUM_conjDEE_3wellsep_n30_noSM_sim_results_2024_11_17"  
...
# remember list structure for var
# head(output$var_list_by_k_stephens$param_list_by_k[[1]])
```

## n = 100

```{r}
sim_dir = "MODSUM_conjDEE_3wellsep_n100_noSM_sim_results_2024_11_17"  

sum2 = sim_diagnostic_sum(data_path = data_path, 
                          sim_dir = sim_dir, 
                          runs_to_plot = 1:5,
                          log_var = TRUE)
...
```{r}
sim_dir = "MODSUM_conjDEE_3wellsep_n300_noSM_sim_results_2024_11_17"  

sum3 = sim_diagnostic_sum(data_path = data_path, 
                          sim_dir = sim_dir, 
                          runs_to_plot = 1:5,
                          log_var = TRUE)
...
# print some examples of K, var, and group assign when spikes or rapid changes
# occur, and when sampler gets stuck -- you have this info in the summary output
output = readRDS(paste0(data_path, "/", sim_dir, "/", "sum_5.rds"))
```
...
```{r}
sim_dir = "MODSUM_conjDEE_3wellsep_n30_withSM_sim_results_2024_11_17"  
...
```{r}
sim_dir = "MODSUM_conjDEE_3wellsep_n100_withSM_sim_results_2024_11_17"  
...
```{r}
sim_dir = "MODSUM_conjDEE_3wellsep_n300_withSM_sim_results_2024_11_17"  
