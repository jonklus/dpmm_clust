---
title: "Diagnostics for DPMM - Updated Close Together Case"
...
sim_diagnostic_sum <- function(data_path, sim_dir, runs_to_plot){
  ...
  diagnostic_sum[i,"MAP_K"] = as.numeric(names(output$k_freqtab)[which.max(as.numeric(output$k_freqtab))])
    ...
    if(run_no %in% runs_to_plot){
        ...
        sigma2_vec = unlist(output$var_list_by_k_stephens)
...
data_path = "/projects/jklus/JKSTproj/BlueHive_Sim_Results/SummaryManuscript"
sim_dir = "MODSUM_conjDEE_3close_n30_noSM_sim_results_2024_11_14"  
...
```{r}
sim_dir = "MODSUM_conjDEE_3close_n100_noSM_sim_results_2024_11_14"  
