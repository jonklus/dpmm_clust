...
## 3d plot
attach(data)
scatterplot3d(x = TSH, y = T3, z = T4, angle = 60)

ggsave(filename = "../thyroid_3blockplot_nocolor.png", device = "png")
# dev.off()
...
```{r}
data_path = "/projects/jklus/JKSTproj/BlueHive_Sim_Results/Archive/RealData"
