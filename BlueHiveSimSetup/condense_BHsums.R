...
# running on server
data_path = "/projects/jklus/JKSTproj/BlueHive_Sim_Results/Summary2"
...
for(ext_index in 3:length(file_ext)){ # skip first one, listing main directory
...
print(summary_table %>%
  dplyr::group_by(Model, Scenario, SM, n_obs, Tag) %>%
...
xtable::xtable(time_table, digits = 0)
