...
sim_results_DEE_with_sm_close = readRDS(file = "../MCMC_Runs/conjDEEsamp_minisimstudy_close_withSM_2024_02_07.rds")
...
output = sim_results_DEV_no_sm_close
dataset_ind = 10
print_phi_sum = FALSE
print_k_sum = TRUE
make_traceplot = TRUE
...
calc_KL = TRUE
mu_true = mu_true
var_true = yreps[[dataset_ind]]$assign
assign_true = NULL
equal_var = FALSE
