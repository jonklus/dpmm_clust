---
title: "Conjugate Sampler - Split/Merge Demo for DEV & DEE"
...
print(mu0)
ex1 = MVN_CRP_sampler_DEV(S = n_iter, y = y, alpha = 1, r = 10, 
                          g = 1, h = 50, 
...
mu0 = matrix(round((colMeans(matrix(unlist(y), ncol = 2))),0), ncol = 1)
print(mu0)
ex1 = MVN_CRP_sampler_DEE(S = n_iter, y = y, alpha = 1, r = 10, 
                          g = 1, h = 50, 
                          sigma_hyperprior = FALSE, fix_r = FALSE, 
                          mu0 = mu0, a = 1, b = 50,
                          k_init = 1, diag_weights = FALSE, 
