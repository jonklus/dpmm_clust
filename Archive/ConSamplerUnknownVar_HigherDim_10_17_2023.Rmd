---
title: "Conjugate Sampler - More Dimensions"
...
plotly::plot_ly() %>%
  add_trace(x = data$y1, y = data$y2, z = data$y3, 
            type = "scatter3d", mode="markers",
            marker = list(color = data$assign))
...
print(mu0)
ex1 = MVN_CRP_sampler_VEE(S = n_iter, y = y, alpha = 1, r = 10, 
                          a = 1, b = 12,
                          d = 1, f = 50,
                          g = 1, h = 50, 
                          ...
                          verbose = FALSE)
saveRDS(object = ex1, file = "./MCMC_Runs/conjVEEsamp_3D_wellsep_a1_b12_d1_f59_g1_h50_rvaries.rds")
...
ex1 = MVN_CRP_sampler_EVV(S = n_iter, y = y, alpha = 1, r = 10, 
                          ...
                          mu0 = mu0, nu = 3, # MUST have nu > p-1 otherwise error
                          lambda0 = diag(x = 5, nrow = 3),
                          k_init = 1, diag_weights = FALSE, 
                          verbose = FALSE)
#saveRDS(object = ex1, file = "./MCMC_Runs/conjEVVsamp_3D_wellsep_nu2_g1_h50_rvaries.rds")
