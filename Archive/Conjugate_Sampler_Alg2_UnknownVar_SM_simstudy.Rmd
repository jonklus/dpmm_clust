...
datafile_name = paste0("../MCMC_Runs/conjDEEsamp_minisimstudy_noSM_", 
                       stringr::str_replace_all(Sys.Date(), pattern = "-", replacement = "_"), ".rds")
saveRDS(object = sim_results_DEE_no_sm, file = datafile_name)
...
datafile_name = paste0("../MCMC_Runs/conjUVVsamp_minisimstudy_noSM_", 
                       stringr::str_replace_all(Sys.Date(), pattern = "-", replacement = "_"), ".rds")
saveRDS(object = sim_results_UVV_no_sm, file = datafile_name)
# saveRDS(object = sim_results_UVV_no_sm, file = "../MCMC_Runs/conjUVVsamp_minisimstudy_noSM_4_Jan_2024.rds")

# for(rep in 1:nreps){
#   print(table(sim_results_UVV_with_sm[[rep]]$k))
#   p1 = make_k_traceplot(k = sim_results_UVV_with_sm[[rep]]$k,
#                         group_assign = sim_results_DEE_with_sm[[rep]]$group_assign)
#   print(p1)
# }
```
...
datafile_name = paste0("../MCMC_Runs/conjUVVsamp_minisimstudy_withSM_", 
                       stringr::str_replace_all(Sys.Date(), pattern = "-", replacement = "_"), ".rds")
saveRDS(object = sim_results_UVV_with_sm, file = datafile_name)
```
...
datafile_name = paste0("../MCMC_Runs/conjDEEsamp_minisimstudy_close_noSM_", 
                       stringr::str_replace_all(Sys.Date(), pattern = "-", replacement = "_"), ".rds")
saveRDS(object = sim_results_DEE_no_sm, file = datafile_name)
...
datafile_name = paste0("../MCMC_Runs/conjUVVsamp_minisimstudy_close_noSM_", 
                       stringr::str_replace_all(Sys.Date(), pattern = "-", replacement = "_"), ".rds")
saveRDS(object = sim_results_UVV_no_sm, file = datafile_name)
# saveRDS(object = sim_results_UVV_no_sm, file = "../MCMC_Runs/conjUVVsamp_minisimstudy_close_noSM_4_Jan_2024.rds")
...
datafile_name = paste0("../MCMC_Runs/conjUVVsamp_minisimstudy_close_withSM_", 
                       stringr::str_replace_all(Sys.Date(), pattern = "-", replacement = "_"), ".rds")
saveRDS(object = sim_results_UVV_with_sm, file = datafile_name)
```
